...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void renderTable(MainActivity context, Response<List<DataModel>> response) {
        ...
        TextView viewHeaderHobi = new TextView(context);
        TextView viewHeaderPekerjaan = new TextView(context);
        TextView viewHeaderAction = new TextView(context);

        viewHeaderId.setText("ID");
        viewHeaderNama.setText("Nama");
        viewHeaderAlamat.setText("Alamat");
        viewHeaderHobi.setText("Hobi");
        ...
        viewHeaderHobi.setPadding(5, 1, 5, 1);
        ...
        barisTabel.addView(viewHeaderHobi);
        ...
        for (DataModel x : datamodels) {
            ...
            TextView viewHobi = new TextView(context);
            viewHobi.setText(x.getHobi());
            viewHobi.setPadding(5, 1, 5, 1);
            barisTabel.addView(viewHobi);

            TextView viewPekerjaan = new TextView(context);
            viewPekerjaan.setText(x.getPekerjaan());
    ...
    public void tambahBiodata() {
        ...
        final EditText editHobi = new EditText(this);
        editHobi.setHint("Hobi");
        layoutInput.addView(editHobi);
        ...
        builderInsertBiodata.setPositiveButton("Insert", new
                DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String hobi = editHobi.getText().toString();
                        ...
                        BiodataAPI biodataapi = retrofit.create(BiodataAPI.class);
                        Call<List<DataModel>> call = biodataapi.insertDataModels(nama, alamat, hobi, pekerjaan);
    ...
    public void getDataByID(int id) {
        ...
        call1.enqueue(new Callback<DataModel>() {
            ...
            public void onResponse(Call<DataModel> call, Response<DataModel> response) {
                ...
                String hobiEdit = datamodels.getHobi();
                String pekerjaanEdit = datamodels.getPekerjaan();
                ...
                final EditText editHobi = new EditText(MainActivity.this);
                editHobi.setText(hobiEdit);
                layoutInput.addView(editHobi);

                final EditText editPekerjaan = new EditText(MainActivity.this);
                ...
                builderEditBiodata.setPositiveButton("Update", new
                        DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                updateDataByID(id, editNama.getText().toString(), editAlamat.getText().toString(), editHobi.getText().toString(), editPekerjaan.getText().toString());
                            }
                        });
    ...
    public void updateDataByID(int id, String nama, String alamat, String hobi, String pekerjaan) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(baseUrl)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        ...
        BiodataAPI biodataapi = retrofit.create(BiodataAPI.class);
        Call<List<DataModel>> call = biodataapi.editDataModels(id, nama, alamat, hobi, pekerjaan);
